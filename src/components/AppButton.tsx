...
const styles = StyleSheet.create({
  button: { minHeight: sizes.button, paddingHorizontal: spacing.lg, paddingVertical: spacing.md, borderRadius: radius.lg, backgroundColor: colors.primary, justifyContent: 'center', alignItems: 'center', gap: spacing.sm, ...shadow },
